"""
Script for preparing 250m buffer data for block_groups.
...
# Load the shapefile
flbg10 = gpd.read_file(shape_path + 'tl_2010_12_bg10/tl_2010_12_bg10.shp')
...
p4bg250m = calculate_intersection(buffer250, flbg10)

# save to CSV
p4bg250m.to_csv(output_path + 'buffer250tobg_all.csv')
