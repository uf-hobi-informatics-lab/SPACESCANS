"""
Script for preparing 250m buffer data for cencus tract.
...
# Load the shapefile
fltract10 = gpd.read_file(shape_path + 'tl_2010_12_tract10/tl_2010_12_tract10.shp')
...
def calculate_intersection(buffered_df, shape_df):
    ...
    return overlap[['value', 'zip9', 'GEOID10']]
...
p4tract250m = calculate_intersection(buffer250, fltract10)

# save to CSV
p4tract250m.to_csv(output_path + 'buffer250totract_all.csv')

# Display the first few rows
print(p4tract250m.head())
