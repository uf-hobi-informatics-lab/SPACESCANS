"""
    ...
    This file contains the table definitions for the ZIP_5 geocoded Exposome 
    SQLite database. 
...
class test_table(exposome_base):
...
class acag(exposome_base):
    __tablename__='ACAG'
    ZIP_5: Mapped[str] = mapped_column(String(5), primary_key=True)
